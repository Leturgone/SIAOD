        ...
        if (cin >> n) {
            if (n == 1) {//создание файла
                if (create_bin_file(tfile_name, bfile_name) == 0) {
                    ...
                    if (create_balance_tree_from_file(bfile_name, tree) == 0) {
                ...
                if (cin >> key) {
                    int z = search_in_file_by_balance_tree(bfile_name, key, tree);
                    if (z == 1) {
                ...
                cin >> i;
                int z = delete_in_file_by_balance_tree(bfile_name, i, tree);
                if (z == 0) {
